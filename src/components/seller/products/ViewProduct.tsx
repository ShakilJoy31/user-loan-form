...
import { ProductImage, ProductItem, ProductItemOption, ProductResponse, ProductVariationType, VariationOption } from "@/types/seller/productInterface";
            ...
            <div>
                ...
                <div className="border rounded-md p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            value={product.name}
                            readOnly
                            className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm text-gray-700 bg-gray-50"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            readOnly
                            className="w-full min-h-[100px] border border-gray-300 rounded-md px-4 py-3 text-sm text-gray-700 bg-gray-50 resize-y"
                        />
                    </div>
                </div>
                ...
                <div className="border rounded-xl p-[24px] mt-6">
                    <div className="mt-10">
                        ...
                        <div
                            className="border rounded p-4 bg-gray-50 min-h-[200px]"
...
const ViewMultiSelectField: React.FC<ViewMultiSelectFieldProps> = ({
    ...
    return (
        <div className="flex flex-col relative h-full">
            ...
            <div className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-700 bg-gray-50 min-h-[42px]">
