...
interface ViewSellerInfoProps {
  isOpen: boolean;
  onClose: () => void;
  seller: SellerRequest;
}

const ViewSellerInfo = ({ isOpen, onClose, seller }: ViewSellerInfoProps) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm">{seller.point}</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-sm">{seller.withdrawPoint}</p>
            </div>
          </div>
        </div>
