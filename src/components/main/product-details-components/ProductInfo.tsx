...
export default function ProductInfo() {
  ...
  <li>
    {translate("α9 Gen5 AI Processor with AI Picture Pro & AI 4K Upscaling", "α9 Gen5 AI প্রসেসর সহ AI পিকচার প্রো এবং AI 4K আপস্কেলিং")}
  </li>
  <li>
    {translate("Pixel Dimming, Perfect Black, 100% Color Fidelity & Color Volume", "পিক্সেল ডিমিং, পারফেক্ট ব্ল্যাক, 100% কালার ফিডেলিটি এবং কালার ভলিউম")}
  </li>
  <li>
    {translate("Hands-free Voice Control, Always Ready", "হ্যান্ডস-ফ্রি ভয়েস কন্ট্রোল, সর্বদা প্রস্তুত")}
  </li>
  <li>
    {translate("Dolby Vision IQ with Precision Detail, Dolby Atmos, Filmmaker Mode", "ডলবি ভিশন আইকিউ সহ প্রিসিশন ডিটেইল, ডলবি এটমস, ফিল্মমেকার মোড")}
  </li>
  <li>
    {translate("Eye Comfort Display: Low-Blue Light, Flicker-Free", "আই কমফোর্ট ডিসপ্লে: লো-ব্লু লাইট, ফ্লিকার-ফ্রি")}
  </li>
</ul>
